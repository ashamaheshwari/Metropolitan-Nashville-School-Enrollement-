...
```{r}
enrollment_22_23 <- subset(enrollment_22_23, select = -c(3, 5, 6, 34))
enrollment_21_22 <- subset(enrollment_21_22, select = -c(3, 5, 6, 34))
enrollment_20_21 <- subset(enrollment_20_21, select = -c(3, 5, 6, 34))
enrollment_19_20 <- subset(enrollment_19_20, select = -c(3, 5, 6, 34))
```
